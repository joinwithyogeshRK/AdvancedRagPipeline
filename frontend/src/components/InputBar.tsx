...
export const InputBar = ({
  ...
  focused, signedIn, inputRef, documents, selectedSource, loadingDocs,  // ← add loadingDocs here
        ...
        {signedIn && hasDocs && (
          ...
          >
            ...
            <motion.button
              ...
              style={{
                ...s.docPill,
                ...(selectedSource === 'all' ? s.docPillActive : {})
              }}
            ...
            {documents.map(doc => (
              <motion.button
                ...
                onClick={() => onSourceChange(
                  selectedSource === doc.source ? 'all' : doc.source
                )}
                style={{
                  ...s.docPill,
                  ...(selectedSource === doc.source ? s.docPillActive : {})
                }}
                whileHover={{ borderColor: "#c9a84c66" }}
                whileTap={{ scale: 0.95 }}
                title={doc.source}
          ...
          placeholder={
            signedIn
              ? selectedSource !== 'all'
                ...
                : "Ask anything… (attach a PDF for document Q&A)"
